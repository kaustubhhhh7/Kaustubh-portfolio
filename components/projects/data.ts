...
export const data: ProjectType[] = [
    {
        icon: 'law',
        title: 'Lawfirm Advocate',
        link: 'https://lawfirm-advocate.netlify.app/',
        description: 'Built an advocate website frontend template featuring elegant typography, responsive layouts, and modern UI components tailored for law firms and legal professionals.'
    },
    {
        icon: 'plane',
        title: 'Scrollscape',
        link: 'https://scrollscape-frontend.netlify.app/',
        description: 'Developed a luxury tour website frontend template with immersive scrolling animations, high-end visuals, and a premium user experience designed for travel agencies.'
    },
    {
        icon: 'layout',
        title: 'PageMint UI',
        link: 'https://pagemint-ui.netlify.app',
        description: 'Created PageMint, a comprehensive UI library featuring 10 different versatile templates in one package, offering reusable components for rapid frontend development.'
    },
    {
        icon: 'file',
        title: 'ResuCraft Builder',
        link: 'https://resucraft-resu-builder.netlify.app/',
        description: 'Built ResuCraft, an intuitive and interactive resume builder application that helps users easily generate professional resumes with real-time preview and export capabilities.'
    },
    {
        icon: 'shop',
